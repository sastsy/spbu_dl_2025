...
## Результаты 
[ссылка на таблицу в гугл диске](https://docs.google.com/spreadsheets/d/1mN7MFDFBfeo-jsFMEuK_2wbf4rvF-vbwrnoW5JV3ucs/edit?usp=sharing)
...
4. Сегментация
5. Детекция
6. Encoder-decoder (image captioning, CLIP).
7. Токены, эмбеддинги (BERT, токенизация)
8. Transformers (GPT-2)
9. Vision transformers ?

# Домашние задания

1. Введение в pytorch и пайплайн обучения. 
2. Свертки, дальнейший пайплайн обучения. Первое соревнование.
3. Классификация. Второе соревнование. 
4. RNN/Сегментация. Третье соревнование.
5. Transformer.  Четвертое соревнование.
...
Мягкий дедлайн по каждому заданию - 14 день после его публикации, время защиты - ближайшая пара и позже. Если задание опубликовано в другой день, то время на выполнение - те же 14 дней, но защита будет после ближайшего занятия после.
Примеры: 
